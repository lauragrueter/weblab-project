...
fitlog wurde in der Blockwoche "WEBLAB" im Frühlingssemester 2026 an der Hochschule Luzern, Studiengang Computer Science, umgesetzt. Das Ziel dieses Projektes ist es, eine Webanwendung von Grund auf zu entwickeln inklusive Deployment. 
...
=== Main Features fitlog
- Workouts manuell tracken (manuelle Eingabe von Einheiten)
- Suchen der Einheiten in einer Listenansicht
...
- Kategorienansicht in einer Tabelle inkl. Suchfunktion
- Workouts einer Kategorie zuordnen
